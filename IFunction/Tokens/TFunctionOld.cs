...
namespace TastyScript.IFunction.TokensOld
{
    /// <summary>
    ...
    /// </summary>
    public class TFunctionOld : Token
    {
        ...
        /// <param name="t"></param>
        public TFunctionOld(BaseFunction callFunction, string args, BaseFunction callingFunction, LoopTracer t = null)
        {
        ...
        public TFunctionOld(BaseFunction callFunction, ExtensionList extensions, string args, BaseFunction callingFunction, LoopTracer t = null)
        {
            Name = callFunction.Name;
            Function = callFunction;
            _value = "<Type.TFunction>";
        ...
        /// <param name="args"></param>
        /// <param name="callingFunction"></param>
        public TFunctionOld(BaseFunction func, ExtensionList ext, string[] args, BaseFunction callingFunction, LoopTracer t = null)
        {
            Name = func.Name;
            Function = func;
            _value = "<Type.TFunction>";
        ...
        public TFunctionOld(BaseFunction func, ExtensionList ext, Dictionary<string, object> args, BaseFunction callingFunction, LoopTracer t = null)
        {
            Name = func.Name;
            Function = func;
            _value = "<Type.TFunction>";
